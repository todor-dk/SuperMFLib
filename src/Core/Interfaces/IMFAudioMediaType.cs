...
namespace MediaFoundation.Core.Interfaces
{
    ...
    internal interface IMFAudioMediaType : IMFMediaType
    {
        ...
        /// Receives the major type <strong>GUID</strong>. The major type describes the broad category of the
        /// format, such as audio or video. For a list of possible values, see <c>Major Media Types</c>. 
        /// </param>
        /// <returns>
        /// The method returns an <strong>HRESULT</strong>. Possible values include, but are not limited to,
        /// those in the following table. 
        ...
        /// Receives a Boolean value. The value is <strong>TRUE</strong> if the format uses temporal
        /// compression, or <strong>FALSE</strong> if the format does not use temporal compression. 
        /// </param>
        /// <returns>
        /// If this method succeeds, it returns <strong>S_OK</strong>. Otherwise, it returns an <strong>HRESULT
        /// </strong> error code. 
        ...
        /// Pointer to the <see cref="IMFMediaType"/> interface of the media type to compare. 
        /// </param>
        /// <param name="pdwFlags">
        /// Receives a bitwise <strong>OR</strong> of zero or more flags, indicating the degree of similarity
        /// between the two media types. The following flags are defined. 
        /// <para/>
        /// <list type="table">
        /// <listheader><term>Value</term><description>Meaning</description></listheader>
        /// <item><term><strong>MF_MEDIATYPE_EQUAL_MAJOR_TYPES</strong>0x00000001</term><description>The major types are the same. The major type is specified by the <see cref="MFAttributesClsid.MF_MT_MAJOR_TYPE"/> attribute. </description></item>
        /// <item><term><strong>MF_MEDIATYPE_EQUAL_FORMAT_TYPES</strong>0x00000002</term><description>The subtypes are the same, or neither media type has a subtype. The subtype is specified by the <see cref="MFAttributesClsid.MF_MT_SUBTYPE"/> attribute. </description></item>
        /// <item><term><strong>MF_MEDIATYPE_EQUAL_FORMAT_DATA</strong>0x00000004</term><description>The attributes in one of the media types are a subset of the attributes in the other, and the values of these attributes match, excluding the value of the <see cref="MFAttributesClsid.MF_MT_USER_DATA"/> attribute. Specifically, the method takes the media type with the smaller number of attributes and checks whether each attribute from that type is present in the other media type and has the same value (not including <see cref="MFAttributesClsid.MF_MT_USER_DATA"/>). To perform other comparisons, use the <see cref="IMFAttributes.Compare"/> method. For example, the <strong>Compare</strong> method can test for identical attributes, or test the intersection of the two attribute sets. For more information, see <see cref="MFAttributesMatchType"/>. </description></item>
        /// <item><term><strong>MF_MEDIATYPE_EQUAL_FORMAT_USER_DATA</strong>0x00000008</term><description>The user data is identical, or neither media type contains user data. User data is specified by the <see cref="MFAttributesClsid.MF_MT_USER_DATA"/> attribute. </description></item>
        /// </list>
        /// </param>
        /// <returns>
        /// The method returns an <strong>HRESULT</strong>. Possible values include, but are not limited to,
        ...
        /// <list type="table">
        /// <listheader><term>Value</term><description>Meaning</description></listheader>
        /// <item><term><strong>AM_MEDIA_TYPE_REPRESENTATION</strong></term><description> Convert the media type to a DirectShow <strong>AM_MEDIA_TYPE</strong> structure. The method selects the most appropriate format structure ( <strong>pbFormat</strong>). </description></item>
        /// <item><term><strong>FORMAT_MFVideoFormat</strong></term><description> Convert the media type to a DirectShow <strong>AM_MEDIA_TYPE</strong> structure with an <see cref="MFVideoFormat"/> format structure. </description></item>
        /// <item><term><strong>FORMAT_VideoInfo</strong></term><description> Convert the media type to a DirectShow <strong>AM_MEDIA_TYPE</strong> structure with a <strong>VIDEOINFOHEADER</strong> format structure. </description></item>
        /// <item><term><strong>FORMAT_VideoInfo2</strong></term><description> Convert the media type to a DirectShow <strong>AM_MEDIA_TYPE</strong> structure with a <strong>VIDEOINFOHEADER2</strong> format structure. </description></item>
        /// </list>
        /// </param>
        ...
        /// <para/>
        /// View the original documentation topic online: 
        /// <a href="http://msdn.microsoft.com/en-US/library/2135FF86-A3B6-4E1C-A9DE-867F4828F008(v=VS.85,d=hv.2).aspx">http://msdn.microsoft.com/en-US/library/2135FF86-A3B6-4E1C-A9DE-867F4828F008(v=VS.85,d=hv.2).aspx</a>
        /// </remarks>
        [PreserveSig]
        ...
        /// </summary>
        /// <param name="guidRepresentation">
        /// GUID that was passed to the <c>GetRepresentation</c> method. 
        /// </param>
        /// <param name="pvRepresentation">
        /// Pointer to the buffer that was returned by the <c>GetRepresentation</c> method. 
        /// </param>
        /// <returns>
        /// If this method succeeds, it returns <strong>S_OK</strong>. Otherwise, it returns an <strong>HRESULT
        /// </strong> error code. 
        ...
        /// <para/>
        /// View the original documentation topic online: 
        /// <a href="http://msdn.microsoft.com/en-US/library/D2007F16-543F-4F05-A44D-B4B4AE8019FB(v=VS.85,d=hv.2).aspx">http://msdn.microsoft.com/en-US/library/D2007F16-543F-4F05-A44D-B4B4AE8019FB(v=VS.85,d=hv.2).aspx</a>
        /// </remarks>
        [PreserveSig]
        ...
        /// media type attributes to get the properties of the audio format.] 
        /// <para/>
        /// Returns a pointer to a <see cref="Misc.WaveFormatEx"/> structure that describes the audio format. 
        /// </summary>
        /// <returns>
        ...
        /// <para/>
        /// View the original documentation topic online: 
        /// <a href="http://msdn.microsoft.com/en-US/library/6A874E7B-9358-45E1-85BE-7207BF46D93E(v=VS.85,d=hv.2).aspx">http://msdn.microsoft.com/en-US/library/6A874E7B-9358-45E1-85BE-7207BF46D93E(v=VS.85,d=hv.2).aspx</a>
        /// </remarks>
