...
namespace MediaFoundation.Core.Interfaces
{
    ...
    public interface IMFPresentationDescriptor : IMFAttributes
    {
        ...
        new int GetItem(
            ...
            [In, Out, MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(PropVariantMarshaler), MarshalCookie = "IMFPresentationDescriptor.GetItem")] PropVariant pValue);
        ...
        new int GetItemByIndex(
            int unIndex,
            out Guid pguidKey,
            [In, Out, MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(PropVariantMarshaler), MarshalCookie = "IMFPresentationDescriptor.GetItemByIndex")] PropVariant pValue);
        ...
        /// <see cref="IMFPresentationDescriptor.GetStreamDescriptorByIndex"/> method.
        /// </summary>
        ...
        /// <see cref="IMFPresentationDescriptor.GetStreamDescriptorCount"/> method.
        /// </param>
        ...
        /// source generates data for that stream when <see cref="IMFMediaSource.Start"/> is called. The media
        ...
        /// <see cref="IMFPresentationDescriptor.DeselectStream"/>.
        /// </param>
        /// <param name="ppDescriptor">
        /// Receives a pointer to the stream descriptor's <see cref="IMFStreamDescriptor"/> interface. The
        ...
        /// call <see cref="IMFPresentationDescriptor.GetStreamDescriptorCount"/>.
        /// </param>
        /// <returns>
        /// The method returns an <strong>HRESULT</strong>. Possible values include, but are not limited to,
        /// those in the following table.
        ...
        /// <listheader><term>Return code</term><description>Description</description></listheader>
        /// <item><term><strong>S_OK</strong></term><description>The method succeeded.</description></item>
        /// <item><term><strong>E_INVALIDARG</strong></term><description><em>dwDescriptorIndex</em> is out of range. </description></item>
        /// </list>
        /// </returns>
        /// <remarks>
        /// <code language="cpp" title="C/C++ Syntax">
        ...
        /// presentation, call the <see cref="IMFPresentationDescriptor.GetStreamDescriptorCount"/> method.
        /// </param>
        /// <returns>
        /// The method returns an <strong>HRESULT</strong>. Possible values include, but are not limited to,
        /// those in the following table.
        ...
        /// Receives a pointer to the <see cref="IMFPresentationDescriptor"/> interface of the new presentation
