...
namespace MediaFoundation.Core.Interfaces
{
    ...
    public interface IMFMediaType : IMFAttributes
    {
        ...
        new int GetItem(
            ...
            [In, Out, MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(PropVariantMarshaler), MarshalCookie = "IMFMediaType.GetItem")] PropVariant pValue);
        ...
        new int GetItemByIndex(
            int unIndex,
            out Guid pguidKey,
            [In, Out, MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(PropVariantMarshaler), MarshalCookie = "IMFMediaType.GetItemByIndex")] PropVariant pValue);
