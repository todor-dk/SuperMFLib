...
namespace MediaFoundation.Core.Interfaces
{
    ...
    public interface IMFStreamDescriptor : IMFAttributes
    {
        ...
        new int GetItem(
            ...
            [In, Out, MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(PropVariantMarshaler), MarshalCookie = "IMFStreamDescriptor.GetItem")] PropVariant pValue);
        ...
        new int GetItemByIndex(
            int unIndex,
            out Guid pguidKey,
            [In, Out, MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(PropVariantMarshaler), MarshalCookie = "IMFStreamDescriptor.GetItemByIndex")] PropVariant pValue);
