...
namespace MediaFoundation.Core.Interfaces
{
    ...
    public interface IMFMediaEvent : IMFAttributes
    {
        ...
        /// </summary>
        /// <param name="pmet">
        /// Receives the event type. For a list of event types, see <c>Media Foundation Events</c>.
        /// </param>
        /// <returns>
        /// The method returns an <strong>HRESULT</strong>. Possible values include, but are not limited to,
        /// those in the following table.
        ...
        /// Receives a <strong>GUID</strong> that identifies the extended type.
        /// </param>
        /// <returns>
        /// The method returns an <strong>HRESULT</strong>. Possible values include, but are not limited to,
        /// those in the following table.
        ...
        /// Receives the event status. If the operation that generated the event was successful, the value is a
        ...
        /// <summary>
        /// Retrieves the value associated with the event, if any. The value is retrieved as a <strong>
        /// PROPVARIANT</strong> structure. The actual data type and the meaning of the value depend on the
        /// event.
        /// </summary>
        /// <param name="pvValue">
        /// Pointer to a <strong>PROPVARIANT</strong> structure. The method fills this structure with the data.
        /// </param>
        /// <returns>
        /// The method returns an <strong>HRESULT</strong>. Possible values include, but are not limited to,
        /// those in the following table.
