...
namespace MediaFoundation.Core.Interfaces
{
    ...
    #region IMFAttributes methods
        ...
        /// enforce, along with configuration data for each protection system. 
        /// </summary>
        /// <param name="dwAttributes">
        /// Describes the output that is represented by the OTA calling this method. This value is a bitwise OR
        /// of zero or more of the following flags. 
        /// <para/>
        /// <list type="table">
        /// <listheader><term>Value</term><description>Meaning</description></listheader>
        /// <item><term><strong>MFOUTPUTATTRIBUTE_BUS</strong></term><description> Hardware bus. </description></item>
        /// <item><term><strong>MFOUTPUTATTRIBUTE_COMPRESSED</strong></term><description> The output sends compressed data. If this flag is absent, the output sends uncompressed data. </description></item>
        /// <item><term><strong>MFOUTPUTATTRIBUTE_BUSIMPLEMENTATION</strong></term><description> Reserved. Do not use. </description></item>
        /// <item><term><strong>MFOUTPUTATTRIBUTE_DIGITAL</strong></term><description> The output sends a digital signal. If this flag is absent, the output sends an analog signal. </description></item>
        /// <item><term><strong>MFOUTPUTATTRIBUTE_NONSTANDARDIMPLEMENTATION</strong></term><description> Reserved. Do not use. </description></item>
        /// <item><term><strong>MFOUTPUTATTRIBUTE_SOFTWARE</strong></term><description> Reserved. Do not use. </description></item>
        /// <item><term><strong>MFOUTPUTATTRIBUTE_VIDEO</strong></term><description> The output sends video data. If this flag is absent, the output sends audio data. </description></item>
        /// </list>
        /// </param>
        /// <param name="guidOutputSubType">
        /// Indicates a specific family of output connectors that is represented by the OTA calling this
        /// method. Possible values include the following. 
        /// <para/>
        /// <list type="table">
        /// <listheader><term>Value</term><description>Meaning</description></listheader>
        /// <item><term><strong>MFCONNECTOR_AGP</strong></term><description> AGP bus. </description></item>
        /// <item><term><strong>MFCONNECTOR_COMPONENT</strong></term><description> Component video. </description></item>
        /// <item><term><strong>MFCONNECTOR_COMPOSITE</strong></term><description> Composite video. </description></item>
        /// <item><term><strong>MFCONNECTOR_D_JPN</strong></term><description> Japanese D connector. (Connector conforming to the EIAJ RC-5237 standard.) </description></item>
        /// <item><term><strong>MFCONNECTOR_DISPLAYPORT_EMBEDDED</strong></term><description> Embedded DisplayPort connector. </description></item>
        /// <item><term><strong>MFCONNECTOR_DISPLAYPORT_EXTERNAL</strong></term><description> External DisplayPort connector. </description></item>
        /// <item><term><strong>MFCONNECTOR_DVI</strong></term><description> Digital video interface (DVI) connector. </description></item>
        /// <item><term><strong>MFCONNECTOR_HDMI</strong></term><description> High-definition multimedia interface (HDMI) connector. </description></item>
        /// <item><term><strong>MFCONNECTOR_LVDS</strong></term><description> Low voltage differential signaling (LVDS) connector.A connector using the LVDS interface to connect internally to a display device. The connection between the graphics adapter and the display device is permanent and not accessible to the user. Applications should not enable High-Bandwidth Digital Content Protection (HDCP) for this connector.</description></item>
        /// <item><term><strong>MFCONNECTOR_PCI</strong></term><description> PCI bus. </description></item>
        /// <item><term><strong>MFCONNECTOR_PCI_Express</strong></term><description> PCI Express bus. </description></item>
        /// <item><term><strong>MFCONNECTOR_PCIX</strong></term><description> PCI-X bus. </description></item>
        /// <item><term><strong>MFCONNECTOR_SPDIF</strong></term><description> Audio data sent over a connector via S/PDIF. </description></item>
        /// <item><term><strong>MFCONNECTOR_SVIDEO</strong></term><description> S-Video connector. </description></item>
        /// <item><term><strong>MFCONNECTOR_UDI_EMBEDDED</strong></term><description> Embedded Unified Display Interface (UDI). </description></item>
        /// <item><term><strong>MFCONNECTOR_UDI_EXTERNAL</strong></term><description> External UDI. </description></item>
        /// <item><term><strong>MFCONNECTOR_UNKNOWN</strong></term><description> Unknown connector type. See Remarks. </description></item>
        /// <item><term><strong>MFCONNECTOR_VGA</strong></term><description> VGA connector. </description></item>
        /// </list>
        /// </param>
        /// <param name="rgGuidProtectionSchemasSupported">
        /// Pointer to an array of GUID values that specify which output protection systems are supported by
        /// the OTA that is calling this method. 
        /// </param>
        /// <param name="cProtectionSchemasSupported">
        /// Number of elements in the <em>rgGuidProtectionSchemasSupported</em> array. 
        /// </param>
        /// <param name="ppRequiredProtectionSchemas">
        /// Receives a pointer to the <see cref="IMFCollection"/> interface of a collection object. The caller
        /// must release the interface. Each object in the collection is an <see cref="IMFOutputSchema"/>
        /// pointer. Each <strong>IMFOutputSchema</strong> pointer defines an output protection system that the
        /// OTA must enforce. 
        /// </param>
        /// <returns>
        /// If this method succeeds, it returns <strong>S_OK</strong>. Otherwise, it returns an <strong>HRESULT
        ...
        /// <summary>
        /// Retrieives a GUID identifying the input trust authority (ITA) that created this output policy
        /// object.
        /// </summary>
        ...
        /// <para/>
        /// View the original documentation topic online: 
        /// <a href="http://msdn.microsoft.com/en-US/library/3412BB81-C4B8-4E10-9A8E-8EAE413CA82D(v=VS.85,d=hv.2).aspx">http://msdn.microsoft.com/en-US/library/3412BB81-C4B8-4E10-9A8E-8EAE413CA82D(v=VS.85,d=hv.2).aspx</a>
        /// </remarks>
        [PreserveSig]
        int GetOriginatorID(
            out Guid pguidOriginatorID
        ...
        /// <summary>
        /// Retrieves the minimum version of the global revocation list (GRL) that must be enforced by the
        /// protected environment for this policy.
        /// </summary>
        ...
        /// <para/>
        /// View the original documentation topic online: 
        /// <a href="http://msdn.microsoft.com/en-US/library/41DA430B-9CDD-4AB0-873D-F6D94F48D401(v=VS.85,d=hv.2).aspx">http://msdn.microsoft.com/en-US/library/41DA430B-9CDD-4AB0-873D-F6D94F48D401(v=VS.85,d=hv.2).aspx</a>
        /// </remarks>
        [PreserveSig]
