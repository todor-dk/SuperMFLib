...
namespace MediaFoundation.Core.Interfaces
{
    ...
    public interface IMFTopologyNode : IMFAttributes
    {
        ...
        new int GetItem(
            ...
            [In, Out, MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(PropVariantMarshaler), MarshalCookie = "IMFTopologyNode.GetItem")] PropVariant pValue);
        ...
        new int GetItemByIndex(
            int unIndex,
            out Guid pguidKey,
            [In, Out, MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(PropVariantMarshaler), MarshalCookie = "IMFTopologyNode.GetItemByIndex")] PropVariant pValue);
        ...
        /// </summary>
        /// <param name="pObject">
        /// A pointer to the object's <strong>IUnknown</strong> interface. Use the value <strong>NULL</strong>
        /// to clear an object that was previous set.
        /// </param>
        /// <returns>
        /// The method returns an <strong>HRESULT</strong>. Possible values include, but are not limited to,
        /// those in the following table.
        ...
        /// <listheader><term>Return code</term><description>Description</description></listheader>
        /// <item><term><strong>S_OK</strong></term><description> The method succeeded. </description></item>
        /// <item><term><strong>E_FAIL</strong></term><description> There is no object associated with this node. </description></item>
        /// </list>
        /// </returns>
        /// <remarks>
        /// <code language="cpp" title="C/C++ Syntax">
        ...
        /// </summary>
        /// <param name="pType">
        /// Receives the node type, specified as a member of the <see cref="MFTopologyType"/> enumeration.
        /// </param>
        /// <returns>
        /// The method returns an <strong>HRESULT</strong>. Possible values include, but are not limited to,
        /// those in the following table.
        ...
        /// <para/>
        /// View the original documentation topic online:
        /// <a href="http://msdn.microsoft.com/en-US/library/9C0E5BE9-6481-4132-AD5B-9DB13FB07391(v=VS.85,d=hv.2).aspx">http://msdn.microsoft.com/en-US/library/9C0E5BE9-6481-4132-AD5B-9DB13FB07391(v=VS.85,d=hv.2).aspx</a>
        /// </remarks>
        [PreserveSig]
        int GetTopoNodeID(
            out long pID);
        ...
        /// </summary>
        /// <param name="ullTopoID">The ull topo identifier.</param>
        /// <returns>
        /// The method returns an <strong>HRESULT</strong>. Possible values include, but are not limited to,
        /// those in the following table.
        /// <para/>
        ...
        /// <listheader><term>Return code</term><description>Description</description></listheader>
        /// <item><term><strong>S_OK</strong></term><description> The method succeeded. </description></item>
        /// <item><term><strong>E_INVALIDARG</strong></term><description> The <c>TOPOID</c> has already been set for this object. </description></item>
        /// </list>
        /// </returns>
        /// <remarks>
        /// <code language="cpp" title="C/C++ Syntax">
        ...
        /// Pointer to the <see cref="IMFTopologyNode"/> interface of the node to connect to.
        /// </param>
        ...
        /// <listheader><term>Return code</term><description>Description</description></listheader>
        /// <item><term><strong>S_OK</strong></term><description>The method succeeded.</description></item>
        /// <item><term><strong>E_FAIL</strong></term><description>The method failed.</description></item>
        /// <item><term><strong>E_INVALIDARG</strong></term><description>Invalid parameter.</description></item>
        /// </list>
        /// </returns>
        /// <remarks>
        /// <code language="cpp" title="C/C++ Syntax">
        ...
        /// <listheader><term>Return code</term><description>Description</description></listheader>
        /// <item><term><strong>S_OK</strong></term><description>The method succeeded.</description></item>
        /// <item><term><strong>E_INVALIDARG</strong></term><description>The <em>dwOutputIndex</em> parameter is out of range. </description></item>
        /// <item><term><strong>MF_E_NOT_FOUND</strong></term><description>The specified output stream is not connected to another node.</description></item>
        /// </list>
        /// </returns>
        /// <remarks>
        /// <code language="cpp" title="C/C++ Syntax">
        ...
        /// Receives a pointer to the <see cref="IMFTopologyNode"/> interface of the node that is connected to
        /// the specified input stream. The caller must release the interface.
        /// </param>
        ...
        /// <listheader><term>Return code</term><description>Description</description></listheader>
        /// <item><term><strong>S_OK</strong></term><description>The method succeeded.</description></item>
        /// <item><term><strong>E_INVALIDARG</strong></term><description>The index is out of range.</description></item>
        /// <item><term><strong>MF_E_NOT_FOUND</strong></term><description>The specified input stream is not connected to another node.</description></item>
        /// </list>
        /// </returns>
        /// <remarks>
        /// <code language="cpp" title="C/C++ Syntax">
        ...
        /// Receives a pointer to the <see cref="IMFTopologyNode"/> interface of the node that is connected to
        /// the specified output stream. The caller must release the interface.
        /// </param>
        ...
        /// <listheader><term>Return code</term><description>Description</description></listheader>
        /// <item><term><strong>S_OK</strong></term><description>The method succeeded.</description></item>
        /// <item><term><strong>E_NOTIMPL</strong></term><description>This node is an output node.</description></item>
        /// </list>
        /// </returns>
        /// <remarks>
        /// <code language="cpp" title="C/C++ Syntax">
        ...
        /// </param>
        /// <param name="ppType">
        /// Receives a pointer to the <see cref="IMFMediaType"/> interface of the media type. The caller must
        ...
        /// <listheader><term>Return code</term><description>Description</description></listheader>
        /// <item><term><strong>S_OK</strong></term><description>The method succeeded.</description></item>
        /// <item><term><strong>E_FAIL</strong></term><description>This node does not have a preferred output type.</description></item>
        /// <item><term><strong>E_INVALIDARG</strong></term><description>Invalid stream index.</description></item>
        /// <item><term><strong>E_NOTIMPL</strong></term><description>This node is an output node.</description></item>
        /// </list>
        /// </returns>
        /// <remarks>
        ...
        /// <listheader><term>Return code</term><description>Description</description></listheader>
        /// <item><term><strong>S_OK</strong></term><description>The method succeeded.</description></item>
        /// <item><term><strong>E_NOTIMPL</strong></term><description>This node is a source node.</description></item>
        /// </list>
        /// </returns>
        /// <remarks>
        /// <code language="cpp" title="C/C++ Syntax">
        ...
        /// <listheader><term>Return code</term><description>Description</description></listheader>
        /// <item><term><strong>S_OK</strong></term><description>The method succeeded.</description></item>
        /// <item><term><strong>E_FAIL</strong></term><description>This node does not have a preferred input type.</description></item>
        /// <item><term><strong>E_INVALIDARG</strong></term><description>Invalid stream index.</description></item>
        /// <item><term><strong>E_NOTIMPL</strong></term><description>This node is a source node.</description></item>
        /// </list>
        /// </returns>
        ...
        /// </summary>
        /// <param name="pNode">
        /// A pointer to the <see cref="IMFTopologyNode"/> interface of the node to copy.
        /// </param>
        /// <returns>
        /// The method returns an <strong>HRESULT</strong>. Possible values include, but are not limited to,
        /// those in the following table.
        ...
        /// <listheader><term>Return code</term><description>Description</description></listheader>
        /// <item><term><strong>S_OK</strong></term><description> The method succeeded. </description></item>
        /// <item><term><strong>MF_E_INVALIDREQUEST</strong></term><description> The node types do not match. </description></item>
        /// </list>
        /// </returns>
        /// <remarks>
        /// <code language="cpp" title="C/C++ Syntax">
