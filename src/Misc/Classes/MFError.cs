...
namespace MediaFoundation.Misc.Classes
{
    ...
    public static class MFError
    {
        ...
        [DllImport("kernel32.dll", CharSet = CharSet.Unicode, EntryPoint = "FormatMessageW", ExactSpelling = true)]
        ...
        [DllImport("kernel32.dll", CharSet = CharSet.Unicode, EntryPoint = "LoadLibraryExW", ExactSpelling = true)]
        [SuppressUnmanagedCodeSecurity]
        ...
        [Flags]
        [UnmanagedName("#defined in WinBase.h")]
