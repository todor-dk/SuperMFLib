...
namespace MediaFoundation.Misc.Interfaces
{
    ...
    internal interface INamedPropertyStore
    {
        ...
        int GetNamedValue(
            ...
            [In, Out, MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(PropVariantMarshaler), MarshalCookie = "INamedPropertyStore.GetNamedValue")] PropVariant pValue
        );
