...
namespace MediaFoundation.MFPlayer.Classes
{
    ...
    /// <para/>
    /// Event structure for the <strong>MFP_EVENT_TYPE_PLAY</strong> event. This event is sent when the 
    /// <see cref="MFPlayer.IMFPMediaPlayer.Play"/> method completes. 
    /// </summary>
    /// <remarks>
    ...
    /// <a href="http://msdn.microsoft.com/en-US/library/2CF8805F-8A3C-45A6-87AD-FA4DA9115833(v=VS.85,d=hv.2).aspx">http://msdn.microsoft.com/en-US/library/2CF8805F-8A3C-45A6-87AD-FA4DA9115833(v=VS.85,d=hv.2).aspx</a>
    /// </remarks>
    ...
    internal class  MFP_PLAY_EVENT : MFP_EVENT_HEADER
    {
        /// <summary>
