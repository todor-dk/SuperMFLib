...
{
    /// <summary>
    /// The <see cref="VideoDisplayControl"/> class implements a wrapper arround the
    ...
    public sealed class VideoDisplayControl : COM<IMFVideoDisplayControl>
    {
        ...
        internal VideoDisplayControl(IMFVideoDisplayControl comInterface)
            : base(comInterface)
        {
        }
        ...
        public static VideoDisplayControl FromService(GetService service)
        {
            ...
            return service.Get<IMFVideoDisplayControl>(MFServices.MF_RATE_CONTROL_SERVICE).ToVideoDisplayControl();
        }
        ...
        public static VideoDisplayControl FromMediaSession(MediaSession session)
        {
            ...
            {
                return VideoDisplayControl.FromService(service);
            }
        }
